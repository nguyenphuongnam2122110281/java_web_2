...
import com.example.NguyenPhuongNam.dto.ProductStoreRequest;
import com.example.NguyenPhuongNam.dto.ProductUpdateRequest;
...
//         List<Product> results = productRepository.findByNameContainingIgnoreCaseAndDeletedAtIsNull(keyword);
//         return ResponseEntity.ok(results);
//     }

@GetMapping("/search")
public ResponseEntity<?> search(@RequestParam("keyword") String keyword) {
    List<Product> result = productRepository.findByNameContainingIgnoreCaseAndDeletedAtIsNull(keyword);
